...
\textbf{Extended security evaluations.} Beyond the \texttt{runc-hardened-test} Flask laboratory, additional scenarios should be reported: CVE-2019-5736 replay, privileged containers and \texttt{docker.sock} mounts, broad capability or host-path misconfigurations, and post-RCE attempts to reach the host or peer containers.
